#!/usr/bin/env python3
"""Generate index.html, albums.html, singers.html, and all-songs.html from
radio/songs.csv (index.html also reads players/*.html for per-album art and
track counts).

This replaces the old build_landing.py (index.html) and build_directories.py
(albums.html/singers.html) with a single script, so the shared chrome (nav
...
Run this whenever songs.csv changes, after sync_albums.py if album
membership changed.
"""
